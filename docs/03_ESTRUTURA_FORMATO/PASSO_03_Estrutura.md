...
* **O que inclui:**
  ...
  * Criação do Banco de Dados consolidado no Notion.
...
* **O que inclui:**
  * 4 encontros ao vivo em grupo explicando o fluxo de ferramentas (WhatsApp export -> Script python/IA -> Notion -> MkDocs/Git).
...
* **O que inclui:**
  * Atualização semanal do painel web Raio-X com novas apresentações.
...
```
[Exportação WhatsApp] ➔ [Script Python / ChatGPT (IA)] ➔ [Notion / Database] ➔ [MkDocs / HTML] ➔ [Hospedagem GitHub Pages / Vercel]
```
